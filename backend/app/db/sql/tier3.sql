-- Tier 3: radius expansion, size ±20%, last 180 days
...
WHERE
  ...
  AND (l.size_sqm IS NULL OR l.size_sqm <= :max_size_sqm)
  AND (l.size_sqm IS NULL OR (l.price_egp / NULLIF(l.size_sqm,0)) BETWEEN :min_price_per_sqm AND :max_price_per_sqm)
