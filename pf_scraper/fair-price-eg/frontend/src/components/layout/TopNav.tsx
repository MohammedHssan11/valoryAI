    ...
    <header className="fixed top-0 z-50 flex w-full items-center justify-between border-b border-white/10 bg-surface/68 px-4 py-4 shadow-[0_8px_30px_rgba(0,0,0,0.24)] backdrop-blur-xl md:px-10">
      ...
      <div className="flex items-center gap-4">
        <div className="hidden md:flex gap-6 font-label-caps text-on-surface-variant text-xs">
          ...
          {currentTab === 'assets' && <span className="text-secondary-fixed">VALUATION ENGINE LIVE</span>}
        </div>
        
        <button type="button" aria-label="Notifications" className="flex h-9 w-9 items-center justify-center rounded-full text-on-surface-variant transition-colors hover:bg-white/5 hover:text-primary-container">
